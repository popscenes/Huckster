...
namespace RestaurantPortal
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<ApplicationUser>(dataProtectionProvider.Create("Huckster Restaurant Portal"));
            }

            EnsureRoleExists("Admin", context);
            EnsureRoleExists("Orders", context);

            string username = "huckster";
            string email = "development@huckster.com.au";
            string password = "Huck123!";
        ...
        private static void EnsureRoleExists(string role, IOwinContext context)
        {
